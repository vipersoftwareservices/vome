...
public class TableWizard extends BorderPane {

    protected Table table = new Table();

    public TableWizard(Table current) { 
        ...
        add(centerPane, 1, 1, 1, UIUtil.newLabel("Table Name"));
        add(centerPane, 2, 1, 1, UIUtil.newComboBox(table, "name", names));

        add(centerPane, 1, 2, 1, UIUtil.newLabel("Table Type:"));
        add(centerPane, 2, 2, 1, UIUtil.newComboBox(table, "tableType", list));

        FlowPane bottomPane = new FlowPane();
        bottomPane.getChildren().add(UIUtil.newButton("Create/Modify Table", this::FinishAction));
