...
public class TestNewConnection extends AbstractTestCase {
    ...
    public void testNewConnection() throws Exception {
        ...
        FXHarness.fire(connectionMenu);

        // FXHarness.fire(FXHarness.lookupMenuItem(connectionMenu, "Exit"));

        // FXHarness.assertEquals("testExitButton", "/unit/data/results/TestNewButton.png", scene);
    }
}
